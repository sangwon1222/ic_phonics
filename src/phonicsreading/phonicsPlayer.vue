...
import { PhonicsApp } from '@/phonicsreading/PhonicsApp';

@Component({
	components: {},
})
export default class PhonicsReading extends Vue {
	$refs: {
	...
	async mounted() {
		...
		new PhonicsApp(this.$refs.canvas);
