...
import AppConf from '../PhonicsConf';
...
export class TopBar extends SceneBase {
	...
	async onInit() {
		...
		this.mIntroBtn = new Button(
			this.mViewSheet.textures['words_btn_off.png'],
			this.mViewSheet.textures['words_btn_on.png'],
		);
		...
		this.mWordsTxtSp = new PIXI.Text('Words');
		this.mWordsTxtSp.style = this.mBtnOffStyle;
		this.mWordsTxtSp.anchor.set(0.5);
		this.mWordsTxtSp.position.set(217, 31);
		this.mWordsTxtSp.scale.set(0.5);
		this.mWordsTxtSp.roundPixels = true;
		this.addChild(this.mWordsTxtSp);

		// Animation 버튼
		this.mStoryBtn = new Button(
			this.mViewSheet.textures['animation_btn_off.png'],
			this.mViewSheet.textures['animation_btn_on.png'],
		);
		...
		this.mAnimationTxtSp.position.set(409, 31);
		...
		this.mChantBtn = new Button(
			this.mViewSheet.textures['activity_btn_off.png'],
			this.mViewSheet.textures['activity_btn_on.png'],
		);
		this.mChantBtn.setAnchor(0.5, 0.5);
		this.mChantBtn.x = 770;
		this.mChantBtn.y = 32;
		this.addChild(this.mChantBtn);

		this.mActivityTxtSp = new PIXI.Text('Activity');
		this.mActivityTxtSp.style = this.mBtnOffStyle;
		this.mActivityTxtSp.anchor.set(0.5);
		this.mActivityTxtSp.position.set(770, 31);
		this.mActivityTxtSp.scale.set(0.5);
		this.mActivityTxtSp.roundPixels = true;
		this.addChild(this.mActivityTxtSp);
		...
		// const titleMainTxt = `${AppConf.LCMS.stepInfo[0].order_no}${AppConf.LCMS.stepInfo[0].lv_nm}`;
